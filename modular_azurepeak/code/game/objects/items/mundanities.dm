...
/obj/item/mundane/puzzlebox/easy/attack_self(mob/living/user)
	...
	if (alert(user, "My fingers trace the outside of this box. It looks of average difficulty. Do I try to solve it?", "EMERALD SUMMIT", "Yes", "No") != "Yes")
		return
...
/obj/item/mundane/puzzlebox/impossible/attack_self(mob/living/user)
	...
	playsound(src.loc, 'sound/items/wood_sharpen.ogg', 75, TRUE)
	playsound(src.loc, 'sound/items/visor.ogg', 75, TRUE)
	if (alert(user, "My fingers trace the outside of this box. It looks nearly impossible. Do I try to solve it?", "EMERALD SUMMIT", "Yes", "No") != "Yes")
		return
