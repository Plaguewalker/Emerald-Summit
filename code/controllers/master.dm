...
/datum/controller/master/Recover()
	...
	if(istype(BadBoy))
		...
		if(msg)
			to_chat_immediate(GLOB.admins, span_admin("ADMIN/MC: [msg]"))
			log_world(msg)
	...
	if (istype(Master.subsystems))
		...
		to_chat_immediate(GLOB.admins, span_admin("The Master Controller is having some issues, we will need to re-initialize EVERYTHING"))
		Initialize(20, TRUE)
...
/datum/controller/master/Initialize(delay, init_sss, tgs_prime)
	...
	to_chat_immediate(GLOB.admins, span_admin("Initializing subsystems..."))
	...
	for (var/datum/controller/subsystem/SS in subsystems)
		...
		to_chat_immediate(GLOB.admins, span_admin(log_msg))
		log_world(log_msg)
...
/datum/controller/master/proc/SetRunLevel(new_runlevel)
	...
	to_chat_immediate(GLOB.admins, span_admin("MC: Runlevel changed from [old_runlevel] to [new_runlevel]"))
