...
/datum/advclass/noble/knighte
	name = "Knight Errant"
	tutorial = "You are a knight from a distant land, a scion of a noble house visiting Emerald Summit for one reason or another."
...
/datum/outfit/job/adventurer/knighte/pre_equip(mob/living/carbon/human/H)
	..()
	to_chat(H, span_warning("You are a knight from a distant land, a scion of a noble house visiting Emerald Summit for one reason or another."))
	var/helmets = list(
